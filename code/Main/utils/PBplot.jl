...
function pbplot(mean::Vector{Vector{Float64}}, upper::Vector{Vector{Float64}}, lower::Vector{Vector{Float64}};
    ...
    if isnothing(axis)
        ...
        ax,legend_elements= pb.PBchart(categories=categories,
                                    ...
                                    legend=legend,
                                    figsize=(5, 5),
                                    offsetcat=offsetcat, scale=4, minscale=-2, median_lw=0.8,axis=ax)
        ...
        ax,legend_elements= pb.PBchart(categories=categories,
                                    ...
                                    legend=legend,
                                    figsize=(5, 5),
                                    offsetcat=offsetcat, scale=4, minscale=-2, median_lw=0.8,axis=axis)
...
function pbplot(vals::Vector{Vector{Float64}};
    ...
    if isnothing(axis)
        ...
        ax,legend_elements= pb.PBchart_(categories=categories,
                        ...
                        legend=legend,
                        figsize=figsize,
                        offsetcat=offsetcat, scale=scale, minscale=minscale, median_lw=0.8,axis=axis)
...
function pbplot(mean::Vector, upper::Vector, lower::Vector;
    ...
    if isnothing(axis)
        ...
        ax,legend_elements= pb.PBchart(categories=categories,
                                    ...
                                    legend=legend,
                                    figsize=(5, 5),
                                    offsetcat=offsetca, scale=4, minscale=-2, median_lw=0.8,axis=axis)
        return ax,legend_elements
    end
...
# # fig, ax = plt.subplots(subplot_kw=Dict("projection" => "polar"))
# fig,ax=pbplot(ASR1[1],categories=categories,
#                 legend=["2025", "2030", "2035", "2040", "2045", "2050"],
#                 figsize=(5, 5), scale=4, minscale=-2, median_lw=0.8)
# display(fig)
